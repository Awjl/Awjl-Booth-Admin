<template>
  <div class='banner'>
    <div class='banneradd'>
      <el-input style="width: 150px;" class="filter-item" placeholder="请输入活动名称" >
      </el-input>
      ...
      <el-button type='primary' icon='el-icon-plus' @click='AddBanner()'>新增活动</el-button>
    </div>
    <div class='dataAll-box'>
      <div class='filter-container'>
        <el-table :data='dataAll.dataList' border style='width: 100%' v-loading='loading'>
          <el-table-column prop='id' label='ID' align='center'></el-table-column>
          <el-table-column prop='titel' label='活动名称' align='center'></el-table-column>
          <el-table-column prop='imgurl' label='图片连接' align='center'></el-table-column>
    ...
    <el-dialog :visible.sync='showdialogForm' :title='title'>
      <el-form ref='dataForm' label-position='right' label-width='20%' style='width: 80%;'>
        <el-form-item label='活动名称' prop='name'>
          <el-input placeholder='请输入图片名称' v-model="newBanner.title"></el-input>
          <span style='position: absolute;bottom:-30px;left:0px;color:red'></span>
        </el-form-item>
        <el-form-item label='图片连接'>
           <el-input placeholder='请输入图片连接' v-model="newBanner.imagesUrl"></el-input>
          <span style='position: absolute;bottom:-30px;left:0px;color:red'></span>
        </el-form-item>
